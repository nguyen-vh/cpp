...
class SFML_WINDOW_API Cursor {
 public:
  ...
  enum Type {
    ...
    SizeLeft,   //!< Left arrow cursor on Linux, same as SizeHorizontal on other
                //!< platforms
    SizeRight,  //!< Right arrow cursor on Linux, same as SizeHorizontal on
                //!< other platforms
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] bool loadFromPixels(const std::uint8_t* pixels, Vector2u size,
                                    Vector2u hotspot);
 ...
 private:
  ...
  // Member data
  ////////////////////////////////////////////////////////////
  std::unique_ptr<priv::CursorImpl>
