...
static constexpr unsigned int Count{
    8};  //!< Maximum number of supported joysticks
static constexpr unsigned int ButtonCount{
    32};  //!< Maximum number of supported buttons
static constexpr unsigned int AxisCount{
    8};  //!< Maximum number of supported axes
...
///
////////////////////////////////////////////////////////////
SFML_WINDOW_API bool isButtonPressed(unsigned int joystick,
                                     unsigned int button);
