...
class SFML_WINDOW_API GlResource {
 protected:
  ...
  ////////////////////////////////////////////////////////////
  /// \brief Register an OpenGL object to be destroyed when its containing
  ...
  /// contexts.
  ///
  /// \param object Object to be destroyed when its containing context is
  /// destroyed
  ///
  ////////////////////////////////////////////////////////////
 ...
 private:
  ...
  ////////////////////////////////////////////////////////////
  std::shared_ptr<void>
      m_sharedContext;  //!< Shared context used to link all contexts together
