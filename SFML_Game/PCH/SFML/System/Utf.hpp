...
class Utf<8> {
 public:
  ...
  static In decode(In begin, In end, std::uint32_t& output,
  ...
  static Out encode(std::uint32_t input, Out output,
...
class Utf<32> {
 public:
  ...
  ////////////////////////////////////////////////////////////
  template <typename In>
  static std::uint32_t decodeAnsi(In input,
                                  const std::locale& locale = std::locale());
  ...
  ////////////////////////////////////////////////////////////
  template <typename Out>
  static Out encodeAnsi(std::uint32_t codepoint, Out output,
                        char replacement = 0,
                        const std::locale& locale = std::locale());
  ...
  ////////////////////////////////////////////////////////////
  template <typename Out>
  static Out encodeWide(std::uint32_t codepoint, Out output,
