...
class Vector2 {
 public:
  ...
  ////////////////////////////////////////////////////////////
  /// \brief Signed angle from \c *this to \c rhs
  /// <i><b>(floating-point)</b></i>.
  ///
  ...
  /// <i><b>(floating-point)</b></i>.
  ///
  /// For example, the vector (1,0) corresponds to 0 degrees, (0,1) corresponds
  /// to 90 degrees.
  ///
  ...
  ////////////////////////////////////////////////////////////
  /// \brief Projection of this vector onto \c axis
  /// <i><b>(floating-point)</b></i>.
  ///
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] SFML_SYSTEM_API Vector2
  projectedOnto(const Vector2& axis) const;
  ...
  ///
  /// Scaling is the most common use case for component-wise
  /// multiplication/division. This operation is also known as the Hadamard or
  /// Schur product.
  ///
  ////////////////////////////////////////////////////////////
  ...
  static const Vector2
      UnitX;  //!< The X unit vector (1, 0), usually facing right
  static const Vector2
      UnitY;  //!< The Y unit vector (0, 1), usually facing down
