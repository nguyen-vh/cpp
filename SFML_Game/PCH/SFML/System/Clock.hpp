...
////////////////////////////////////////////////////////////
    ...
    defined(SFML_ANDROID_USE_SUSPEND_AWARE_CLOCK)
...
static_assert(
    std::ratio_less_equal_v<ClockImpl::period, std::micro>,
...
class SFML_SYSTEM_API Clock {
 ...
 private:
  ...
  // Member data
  ////////////////////////////////////////////////////////////
  priv::ClockImpl::time_point m_refPoint{
      priv::ClockImpl::now()};              //!< Time of last reset
