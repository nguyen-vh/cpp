 ...
 public:
  ...
  class SFML_NETWORK_API Response {
   public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    explicit Response(Status code = Status::InvalidResponse,
                      std::string message = "");
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] Response connect(const IpAddress& server,
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] Response login(const std::string& name,
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] ListingResponse getDirectoryListing(
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] Response renameFile(const std::filesystem::path& file,
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] Response sendCommand(const std::string& command,
...
/// response = ftp.upload("local-path/file.txt", "files",
/// sf::Ftp::TransferMode::Ascii); if (response.isOk())
