...
class SFML_NETWORK_API TcpSocket : public Socket {
 public:
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] Status connect(const IpAddress& remoteAddress,
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] Status receive(void* data, std::size_t size,
                               std::size_t& received);
  ...
  /// sf::Socket::Status::Partial, you \em must retry sending the same
  /// unmodified packet before sending anything else in order to guarantee the
  /// packet arrives at the remote peer uncorrupted. This function will fail if
 ...
 private:
  ...
  PendingPacket m_pendingPacket;  //!< Temporary data of the packet currently
                                  //!< being received
  std::vector<std::byte> m_blockToSendBuffer;  //!< Buffer used to prepare data
                                               //!< being sent from the socket
};
