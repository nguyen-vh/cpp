...
class SFML_NETWORK_API IpAddress {
 public:
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] static std::optional<IpAddress> resolve(
  ...
  ///
  ////////////////////////////////////////////////////////////
  IpAddress(std::uint8_t byte0, std::uint8_t byte1, std::uint8_t byte2,
            std::uint8_t byte3);
...
/// Usage example:
/// \code
/// auto a2 = sf::IpAddress::resolve("127.0.0.1");      // the local host
/// address auto a3 = sf::IpAddress::Broadcast;                 // the broadcast
/// address sf::IpAddress a4(192, 168, 1, 56);                  // a local
/// address auto a5 = sf::IpAddress::resolve("my_computer");    // a local
/// address created from a network name auto a6 =
/// sf::IpAddress::resolve("89.54.1.169");    // a distant address auto a7 =
/// sf::IpAddress::resolve("www.google.com"); // a distant address created from
/// a network name auto a8 = sf::IpAddress::getLocalAddress();         // my
/// address on the local network auto a9 = sf::IpAddress::getPublicAddress(); //
/// my address on the internet \endcode
///
