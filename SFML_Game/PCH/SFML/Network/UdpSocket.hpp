...
class SFML_NETWORK_API UdpSocket : public Socket {
 public:
  ...
  static constexpr std::size_t MaxDatagramSize{
      65507};  //!< The maximum number of bytes that can be sent in a single UDP
               //!< datagram
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] Status bind(unsigned short port,
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] Status send(Packet& packet, const IpAddress& remoteAddress,
                            unsigned short remotePort);
 ...
 private:
  ...
  std::vector<std::byte> m_buffer{
      MaxDatagramSize};  //!< Temporary buffer holding the received data in
                         //!< Receive(Packet)
};
...
/// else) char buffer[1024]; std::size_t received = 0;
