 ...
 public:
  ...
  class SFML_NETWORK_API Request {
   public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    Request(const std::string& uri = "/", Method method = Method::Get,
   ...
   private:
    ...
    using FieldTable =
        std::map<std::string,
                 std::string>;  // Use an ordered map for predictable payloads
  ...
  class SFML_NETWORK_API Response {
   public:
    ...
    enum class Status {
      ...
      NotModified =
          304,  //!< For conditional requests, means the requested page hasn't
