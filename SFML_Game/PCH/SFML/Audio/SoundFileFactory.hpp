...
class SFML_AUDIO_API SoundFileFactory {
 public:
  ...
  ///
  ////////////////////////////////////////////////////////////
  static std::unique_ptr<SoundFileReader> createReaderFromMemory(
  ...
  ///
  ////////////////////////////////////////////////////////////
  static std::unique_ptr<SoundFileReader> createReaderFromStream(
      InputStream& stream);
  ...
  ///
  ////////////////////////////////////////////////////////////
  static std::unique_ptr<SoundFileWriter> createWriterFromFilename(
      const std::filesystem::path& filename);
