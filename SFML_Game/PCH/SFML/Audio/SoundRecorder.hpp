...
class SFML_AUDIO_API SoundRecorder : AlResource {
 ...
 protected:
  ...
  ///
  ////////////////////////////////////////////////////////////
  [[nodiscard]] virtual bool onProcessSamples(const std::int16_t* samples,
 ...
 private:
  ...
  Time m_processingInterval{
      milliseconds(100)};  //!< Time period between calls to onProcessSamples
  bool m_isCapturing{};    //!< Capturing state
  std::string m_deviceName{
      getDefaultDevice()};         //!< Name of the audio capture device
...
///     }
///
///     [[nodiscard]] bool onProcessSamples(const std::int16_t* samples,
