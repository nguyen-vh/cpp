...
class SFML_GRAPHICS_API Texture : GlResource {
 public:
  ...
  ///
  ////////////////////////////////////////////////////////////
  void update(const std::uint8_t* pixels, const Vector2u& size,
              const Vector2u& dest);
 ...
 private:
  ...
  std::uint64_t m_cacheId;  //!< Unique number that identifies the texture to
...
///
///     // update the texture
///     std::uint8_t* pixels = ...; // get a fresh chunk of pixels (the next
