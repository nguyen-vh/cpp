...
class Transform {
 public:
  ...
  ///
  ////////////////////////////////////////////////////////////
  constexpr Transform(float a00, float a01, float a02, float a10, float a11,
  ...
  /// \code
  /// sf::Transform transform;
  /// transform.rotate(sf::degrees(90), sf::Vector2f(8,
  /// 3)).translate(sf::Vector2f(50, 20)); \endcode
  ///
  /// \param angle Rotation angle
