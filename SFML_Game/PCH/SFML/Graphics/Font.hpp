...
class SFML_GRAPHICS_API Font {
 public:
  ...
  ///
  ////////////////////////////////////////////////////////////
  const Glyph& getGlyph(std::uint32_t codePoint, unsigned int characterSize,
  ...
  float getKerning(std::uint32_t first, std::uint32_t second,
                   unsigned int characterSize, bool bold = false) const;
 ...
 private:
  ...
  using GlyphTable =
      std::unordered_map<std::uint64_t,
                         Glyph>;  //!< Table mapping a codepoint to its glyph
  ...
  ///
  ////////////////////////////////////////////////////////////
  Glyph loadGlyph(std::uint32_t codePoint, unsigned int characterSize,
  ...
  struct FontHandles;
  using PageTable =
      std::unordered_map<unsigned int, Page>;  //!< Table mapping a character
                                               //!< size to its page (texture)

  ////////////////////////////////////////////////////////////
  // Member data
  ////////////////////////////////////////////////////////////
  std::shared_ptr<FontHandles>
      m_fontHandles;  //!< Shared information about the internal font instance
...
#ifdef SFML_SYSTEM_ANDROID
  std::unique_ptr<priv::ResourceStream>
      m_stream;  //!< Asset file streamer (if loaded from file)
#endif
};
